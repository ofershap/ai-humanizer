---
name: ai-humanizer
description: Prevent AI-detectable patterns in all generated content - prose, code comments, commit messages, docs, and READMEs
metadata:
...
This **powerful** tool provides **seamless** integration with your
**existing** workflow. Key **features** include:
