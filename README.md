...
Make AI-generated content undetectable. Prevents the patterns AI detectors and experienced
developers flag - em dashes, buzzwords, over-formatting, narrating comments, git co-author trailers,
and uniform sentence structure.

> AI detectors look for statistical patterns, not meaning. This plugin prevents those patterns at
> the source. The agent writes human-sounding content from the start instead of you fixing it after.
...
- [think-first](https://github.com/ofershap/think-first) - Plan-first workflow (pairs well with
  humanized output)
